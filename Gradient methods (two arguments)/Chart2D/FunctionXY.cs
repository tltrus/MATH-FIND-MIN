...
namespace _Chart2D
{
    internal class FunctionXY
    {
        ...
        double XSpacing = 0.05;
        double YSpacing = 0.05;
        ...
        public FunctionXY(double width, double height, int contours = 10, double Xmin = -10, double Xmax = 10, double Ymin = -10, double Ymax = 10)
        {
            this.width = width;
            this.height = height;
